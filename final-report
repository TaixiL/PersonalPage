...
<html>
    ...
    <body>
        ...
        <object data="https://taixil.github.io/STOR-565-Final-Project/FinalReport.pdf" type="application/pdf" width="1200px" height="1000px">
        </object>
        <p>

        </p>

        <p>If this browser does not support HTML, please download the file to view it: <a href="https://github.com/TaixiL/STOR-565-Final-Project/blob/main/FinalReport.pdf">Download PDF</a>.</p>
    </body>
</html>
