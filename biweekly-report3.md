...
<html>
    ...
    <body>
          ...
          <div class="dropdown-container">
            ...
            <a href="https://taixil.github.io/STOR-565-Final-Project/biweekly-report2">Report 3</a>
          </div>
        ...
        <object data="https://taixil.github.io/STOR-565-Final-Project/Outliers_04-06-2022.pdf" type="application/pdf" width="1200px" height="1000px">
        </object>
        <p>

        </p>

        <p>If this browser does not support PDFs, please download the PDF to view it: <a href="https://github.com/TaixiL/STOR-565-Final-Project/blob/main/Outliers_04-06-2022.pdf">Download PDF</a>.</p>
    </body>
</html>
